...
metadata:
  ...
  dependencies:
    ...
    - id: agent-mail
      ...
      config_sources: [project_opencode_config, user_opencode_config, bundle_opencode_config_template]
      missing_effect: unavailable
...
2. If present, run **`node .opencode/khuym_status.mjs --json`** — quick onboarding/state/handoff scout
