...
Launch three parallel parallel agents or separate Antigravity workspaces using the Antigravity runtime available in the session. Each writes findings to a temp file.
