...
| Placeholder | Source |
|---|---|
| `<WORKER_RUNTIME_NAME>` | Nickname returned by the runtime `delegate workflow` result |
...
2. On startup:
   startup = macro_start_session(human_key="/home/user/projects/myapp", model="gpt-5", program="kiro-cli", task_description="khuym worker execution", agent_name="Peirce")
