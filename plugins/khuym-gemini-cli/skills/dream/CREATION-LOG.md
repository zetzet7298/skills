...
- Khuym process contracts from `GEMINI.md`
- Locked decisions from `history/dream-skill/CONTEXT.md` (D1-D6)

What the source does:
- Defines a manual, repo-scoped dream consolidation pass over Gemini CLI session artifacts and learnings files.
...
`khuym/dream/SKILL.md` and references were authored in `br-11w`, then pressure scenarios were replayed.
