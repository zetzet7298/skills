...
Examples:
- Re-read GEMINI.md before continuing
...
**Purpose:** Forces the worker back onto the thread and back through `GEMINI.md`
...
Before replying, re-read `GEMINI.md` if you compacted or drifted, then run `fetch_inbox(...)`.
```
