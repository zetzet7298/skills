...
Launch three parallel parallel agents or separate Gemini CLI workspaces using the Gemini CLI runtime available in the session. Each writes findings to a temp file.
