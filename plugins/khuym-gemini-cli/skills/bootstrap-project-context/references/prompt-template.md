...
```text
First, read `GEMINI.md` and `README.md` completely and carefully if they exist. Treat both files as mandatory context, and do not start code investigation until you fully understand the operating instructions, project framing, and documented workflows in them.
...
- any especially important instructions or constraints from `GEMINI.md`
