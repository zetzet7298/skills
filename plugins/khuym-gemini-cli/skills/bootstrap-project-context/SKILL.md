...
description: Bootstrap a new AI-agent session by reading the repository operating docs and rebuilding project understanding from source. Use when Gemini CLI needs to start a new conversation, get up to speed on an unfamiliar repo, read GEMINI.md and README.md completely before acting, investigate the codebase to understand the project's purpose and architecture, or turn a rough onboarding prompt into an execution-ready repo-orientation prompt.
metadata:
  dependencies: []
---
...
- notable conventions or operating constraints from `GEMINI.md`
...
- require a complete read of `GEMINI.md` and `README.md` before code investigation
...
- skimming `GEMINI.md` or `README.md`
...
- begins with a full read of `GEMINI.md` and `README.md` when present
