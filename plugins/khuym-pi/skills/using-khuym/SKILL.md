...
- repo-local `.pi/khuym_status.mjs`
- repo-local `.pi/khuym_state.mjs`
- repo-local `.pi/khuym_dependencies.mjs`
...
- `node plugins/khuym-pi/skills/using-khuym/scripts/test_onboard_khuym.mjs`
- `bash scripts/check-markdown-links.sh plugins/khuym-pi/skills/using-khuym/SKILL.md`
...
0.5. If .pi/khuym_status.mjs exists: run `node .pi/khuym_status.mjs --json`
...
This is the default way Pi and GPT-family models should communicate anywhere inside the Khuym workflow unless a narrower skill requires something stricter.
